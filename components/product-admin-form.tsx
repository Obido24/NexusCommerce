  ...
  return (
    <form action={submit} className="surface-card p-5">
      ...
      <div className="mt-5 grid gap-4 sm:grid-cols-2">
        ...
        <label><span className="text-sm font-semibold">Price</span><input name="price" type="number" step="0.01" required placeholder="45000" className="focus-ring mt-1 h-10 w-full rounded-md border border-outline-variant px-3 text-sm" /></label>
        <label><span className="text-sm font-semibold">Compare price</span><input name="comparePrice" type="number" step="0.01" placeholder="60000" className="focus-ring mt-1 h-10 w-full rounded-md border border-outline-variant px-3 text-sm" /></label>
